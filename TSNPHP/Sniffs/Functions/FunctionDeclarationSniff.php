<?php
//based on PEAR_Sniffs_Functions_FunctionDeclarationSniff
/**
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class TSNPHP_Sniffs_Functions_FunctionDeclarationSniff implements PHP_CodeSniffer_Sniff
{
     ...
     *
     * Just uses the Generic Kernighan Ritchie brace sniff.
     *
     * @param PHP_CodeSniffer_File $phpcsFile The file being scanned.
     * @param int                  $stackPtr  The position of the current token
     *                                        in the stack passed in $tokens.
